...
class BaseBot(commands.Cog, metaclass=BaseBotMeta):
    """
    Базовый класс для создания бота. Используйте его, а не Cog, 
    так как в дальнейшем на его основе будет добавлена поддержка распознавание намереней и контекста из свободной речи
